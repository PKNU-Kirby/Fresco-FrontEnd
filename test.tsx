...
const AddItemScreen: React.FC = () => {
  ...
  const handleSuccessConfirm = useCallback(() => {
    ...
    // MainTabs로 navigate하고 특정 탭과 파라미터 전달
    navigation.navigate('MainTabs', {
      fridgeId,
      fridgeName: '냉장고', // 실제 냉장고 이름으로 변경 필요
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        <AddItemHeader
          title={isEditMode ? '식재료 추가' : '식재료 확인'}
          onBack={handleGoBack}
          showBackButton={true}
        />
        ...
        <AddItemActions
          ...
          onConfirmIngredients={confirmIngredients}
          onSaveItems={() => setShowFinalConfirmModal(true)}
          onBackToEdit={handleBackToEdit}
          validateAllItems={validateAllItems}
        />
      </KeyboardAvoidingView>
